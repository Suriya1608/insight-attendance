...
<div style="display:flex;align-items:center;gap:.75rem;margin-bottom:1.5rem;">
    <a href="{{ route('manager.my-tasks.index') }}" style="display:inline-flex;align-items:center;justify-content:center;width:34px;height:34px;border-radius:var(--radius-sm);border:1px solid var(--border);background:var(--surface);color:var(--text-secondary);text-decoration:none;" onmouseover="this.style.background='var(--bg-light)'" onmouseout="this.style.background='var(--surface)'">
...
<div class="detail-grid">
    <div>
        ...
        <div class="d-card">
            ...
            <div class="d-card-body">
                ...
                <form method="POST" action="{{ route('manager.my-tasks.comment', $task) }}" class="comment-form">
                    @csrf
    ...
    <div>
        ...
        <div class="d-card">
            ...
            <div class="d-card-body">
                <form method="POST" action="{{ route('manager.my-tasks.status', $task) }}">
                    @csrf @method('PATCH')
        ...
        <div class="d-card">
            <div class="d-card-body" style="text-align:center;padding:1.5rem 1.25rem;">
                ...
                <div style="font-size:.8rem;color:var(--text-muted);">Your manager has been notified.</div>
            </div>
        </div>
        @endif
