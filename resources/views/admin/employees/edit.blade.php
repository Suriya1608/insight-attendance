...
<style>
    ...
    #photoPreview { width: 80px; height: 80px; border-radius: 50%; object-fit: cover; margin: 0 auto .5rem; display: block; }

    /* Current photo */
    .current-photo {
        display: flex; align-items: center; gap: 12px;
        padding: .75rem; background: var(--bg-light);
...
@section('content')
    ...
    <p class="page-subtitle">Update the details for <strong>{{ $employee->name }}</strong> ({{ $employee->employee_code }})</p>

    <form method="POST" action="{{ route('admin.employees.update', $employee) }}" enctype="multipart/form-data" novalidate>
        @csrf
        @method('PUT')
        ...
        <div class="form-layout">
                    ...
                    <div class="grid-2 mb-3">
                        <div>
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                                   value="{{ old('name', $employee->name) }}" placeholder="e.g. Rahul Sharma" required autofocus>
                            @error('name')<span class="invalid-feedback">{{ $message }}</span>@enderror
                        </div>
                        <div>
                            <label class="form-label">Email ID <span class="req">*</span></label>
                            <input type="email" name="email" class="form-control @error('email') is-invalid @enderror"
                                   value="{{ old('email', $employee->email) }}" placeholder="e.g. rahul@company.com" required>
                    ...
                    <div class="grid-3 mb-3">
                        <div>
                            ...
                            <div class="phone-group">
                                ...
                                <input type="tel" name="mobile" class="form-control @error('mobile') is-invalid @enderror"
                                       ...
                                       placeholder="9876543210" maxlength="10" inputmode="numeric" oninput="numericOnly(this)">
                            </div>
                        ...
                        <div>
                            ...
                            <input type="date" name="dob" class="form-control @error('dob') is-invalid @enderror"
                                   value="{{ old('dob', $employee->dob?->format('Y-m-d')) }}" max="{{ date('Y-m-d') }}">
                        ...
                        <div>
                            ...
                            <input type="date" name="doj" class="form-control @error('doj') is-invalid @enderror"
                                   value="{{ old('doj', $employee->doj?->format('Y-m-d')) }}">
                    ...
                    <div>
                        ...
                        @if($detail?->profile_image)
                            <div class="current-photo">
                                <img src="{{ Storage::url($detail->profile_image) }}" alt="{{ $employee->name }}">
                                <span>Current photo — upload a new one below to replace it.</span>
                            </div>
                        @else
                            <div class="current-photo">
                                <div class="initials-avatar">{{ $employee->initials() }}</div>
                        ...
                        <div class="photo-upload-area" onclick="document.getElementById('photoInput').click()">
                            ...
                            <img id="photoPreview" alt="Preview"
                                 @if($detail?->profile_image)
                                     src="{{ Storage::url($detail->profile_image) }}"
                                 @else
                                     style="display:none;"
                                 @endif>
                            <span class="material-symbols-outlined" id="uploadIcon"
                                  @if($detail?->profile_image) style="display:none;" @endif>
                                add_photo_alternate
                            </span>
                            <p>Click to upload a new photo (max 2MB)</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="grid-2">
                        <div>
                            ...
                            <input type="text" name="aadhaar_number"
                                   ...
                                   value="{{ old('aadhaar_number', $detail?->aadhaar_number) }}"
                                   placeholder="12-digit Aadhaar" maxlength="12" inputmode="numeric" oninput="numericOnly(this)">
                    ...
                    <div class="grid-3">
                        ...
                        <div>
                            ...
                            <input type="text" name="bank_account_number"
                                   ...
                                   value="{{ old('bank_account_number', $detail?->bank_account_number) }}"
                                   placeholder="Account number" maxlength="20" inputmode="numeric" oninput="numericOnly(this)">
                        ...
                        <div>
                            ...
                            <input type="text" name="ifsc_code"
                                   ...
                                   value="{{ old('ifsc_code', $detail?->ifsc_code) }}"
                    ...
                    <div>
                        ...
                        <div class="phone-group">
                            ...
                            <input type="tel" name="emergency_contact"
                                   ...
                                   value="{{ old('emergency_contact', $detail?->emergency_contact ? preg_replace('/^\+91/', '', $detail->emergency_contact) : '') }}"
                                   placeholder="9876543210" maxlength="10" inputmode="numeric" oninput="numericOnly(this)">
                        </div>
                    ...
                    <div class="grid-3">
                        <div>
                            ...
                            <input type="text" name="city"
                                   ...
                                   value="{{ old('city', $detail?->city) }}" placeholder="City">
                        ...
                        <div>
                            ...
                            <input type="text" name="state"
                                   ...
                                   value="{{ old('state', $detail?->state) }}" placeholder="State">
                        ...
                        <div>
                            ...
                            <div style="display:flex;">
                                ...
                                <input type="number" name="salary" step="0.01" min="0"
                                       ...
                                       value="{{ old('salary', $employee->salary) }}" placeholder="e.g. 25000.00"
                        ...
                        <div>
                            ...
                            <select name="blood_group" class="form-select @error('blood_group') is-invalid @enderror">
                                ...
                                @foreach(['A+','A-','B+','B-','AB+','AB-','O+','O-'] as $bg)
                                    <option value="{{ $bg }}"
                                        {{ old('blood_group', $detail?->blood_group) === $bg ? 'selected' : '' }}>
                                        {{ $bg }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div style="display:flex; gap:.75rem; flex-wrap:wrap;">
                            <label style="display:flex;align-items:center;gap:.5rem;cursor:pointer;
                                ...
                                <input type="radio" name="role" value="employee" id="roleEmployee"
                                       {{ old('role', $employee->role) === 'employee' ? 'checked' : '' }}
                            ...
                            <label style="display:flex;align-items:center;gap:.5rem;cursor:pointer;
                                ...
                                <input type="radio" name="role" value="manager" id="roleManager"
                                       {{ old('role', $employee->role) === 'manager' ? 'checked' : '' }}
                                       style="accent-color:var(--primary);">
                                <span>Manager</span>
                            </label>
                        </div>
                    ...
                    <div class="grid-2">
                        <div>
                            ...
                            <select name="level1_manager_id" id="level1Select"
                                ...
                                @foreach($managers as $mgr)
                                    <option value="{{ $mgr->id }}"
                                        {{ old('level1_manager_id', $employee->level1_manager_id) == $mgr->id ? 'selected' : '' }}>
                                        {{ $mgr->name }}
                        ...
                        <div id="level2Group">
                            ...
                            <select name="level2_manager_id" id="level2Select"
                                ...
                                @foreach($managers as $mgr)
                                    <option value="{{ $mgr->id }}"
                                        {{ old('level2_manager_id', $employee->level2_manager_id) == $mgr->id ? 'selected' : '' }}>
                                        {{ $mgr->name }}
                                        @if($mgr->department) ({{ $mgr->department->name }}) @endif
                                    </option>
                                @endforeach
            ...
            <div class="form-actions">
                ...
                <a href="{{ route('admin.employees.show', $employee) }}" class="btn-cancel">
...
let _unTimer = null;
const _unExcludeId = '{{ \App\Helpers\IdCrypt::encode($employee->id) }}';
function checkUsername(input) {
    ...
    _unTimer = setTimeout(() => {
        fetch(`{{ route('admin.employees.check-username') }}?username=${encodeURIComponent(val)}&exclude_id=${_unExcludeId}`)
            .then(r => r.json())
            .then(data => {
                icon.style.animation = '';
                if (data.available) {
