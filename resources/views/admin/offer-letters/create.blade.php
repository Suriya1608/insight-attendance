...
@section('title', 'New Offer Letter')
...
@section('content')
    ...
    <div class="page-title">New Offer Letter</div>
    <p class="page-subtitle">Fill in the candidate details to generate an offer letter.</p>
    ...
    <div class="form-card">
        ...
        <div class="form-card-body">
            ...
            <form method="POST" action="{{ route('admin.offer-letters.store') }}" novalidate>
                @csrf
                ...
                <div class="mb-4">
                    ...
                    <textarea id="content" name="content" rows="4"
                              ...
                              placeholder="Any special terms, conditions, or notes to include in the offer letter…">{{ old('content') }}</textarea>
