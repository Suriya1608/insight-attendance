...
<style>
    ...
    .form-row-3 { display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 1.25rem; margin-bottom: 1.25rem; }
    ...
    .radio-option .type-dot { width: 10px; height: 10px; border-radius: 50%; }
...
@section('content')
    ...
    <div class="page-header">
        <h1>
            <span class="material-symbols-outlined" style="font-size:1.4rem; color:var(--primary); font-variation-settings:'FILL' 1;">add_circle</span>
            Add Holiday
        </h1>
        <p>Add a new national or optional holiday</p>
    </div>

    <form method="POST" action="{{ route('admin.holidays.store') }}" id="holidayForm">
        @csrf
        <div class="form-grid">
                    ...
                    <div class="form-card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                                   value="{{ old('name') }}" placeholder="e.g. Independence Day" autofocus>
                            ...
                            <div class="form-group" style="margin-bottom:0;">
                                ...
                                <div class="radio-group" style="margin-top:.35rem;">
                                    <label class="radio-option">
                                        <input type="radio" name="type" value="national" {{ old('type','national') === 'national' ? 'checked' : '' }} onchange="updateSummary()">
                                        <span class="type-dot dot-national"></span> National
                                    </label>
                                    <label class="radio-option">
                                        <input type="radio" name="type" value="optional" {{ old('type') === 'optional' ? 'checked' : '' }} onchange="updateSummary()">
                        ...
                        <div class="form-group" style="margin-top:1.25rem;">
                            ...
                            <div class="scope-options">
                                <label class="scope-option">
                                    <input type="radio" name="scope" value="all" {{ old('scope','all') === 'all' ? 'checked' : '' }} onchange="toggleDept(this.value)">
                                    <span class="material-symbols-outlined">domain</span>
                                    All Departments
                                </label>
                                <label class="scope-option">
                                    <input type="radio" name="scope" value="department" {{ old('scope') === 'department' ? 'checked' : '' }} onchange="toggleDept(this.value)">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" class="form-control @error('description') is-invalid @enderror"
                                      rows="3" placeholder="Optional note about this holiday...">{{ old('description') }}</textarea>
                ...
                <div class="sidebar-card">
                    ...
                    <div class="sidebar-card-body">
                        <div class="summary-row">
                            ...
                            <span class="summary-value" id="prevName">—</span>
                        </div>
                        <div class="summary-row">
                            <span class="summary-label">Date</span>
                            <span class="summary-value" id="prevDate">—</span>
                        </div>
                        <div class="summary-row">
                            <span class="summary-label">Day</span>
                            <span class="summary-value" id="prevDay">—</span>
                        </div>
                        <div class="summary-row">
                            <span class="summary-label">Type</span>
                            <span class="summary-value" id="prevType">National</span>
                        </div>
                        <div class="summary-row">
                            <span class="summary-label">Scope</span>
                            <span class="summary-value" id="prevScope">All Departments</span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="sidebar-card-body">
                        <div class="toggle-wrap">
                            <label class="toggle-switch">
                                <input type="checkbox" name="status" value="1" {{ old('status', '1') ? 'checked' : '' }} id="statusToggle">
                                <span class="toggle-slider"></span>
                            </label>
                            <span class="toggle-desc" id="statusLabel">Active — will appear in employee calendar</span>
                        </div>
                    </div>
                </div>
