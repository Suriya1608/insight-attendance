...
<div style="margin-bottom:1.5rem;">
    ...
    <p class="page-subtitle" style="margin-bottom:0;">Tasks assigned to you by your manager.</p>
</div>
    ...
    <form method="GET" action="{{ route('employee.tasks.index') }}">
        <div class="filter-bar">
            ...
            @if(request()->hasAny(['status','priority']))
                <a href="{{ route('employee.tasks.index') }}" class="btn-filter">Clear</a>
            @endif
        </div>
    </form>
            ...
            <tbody>
                @forelse($tasks as $i => $task)
                    ...
                    <tr class="{{ $overdue ? 'row-overdue' : '' }}">
                        ...
                        <td>
                            <a href="{{ route('employee.tasks.show', $task) }}" class="act-btn" title="View Details">
